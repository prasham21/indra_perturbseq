"""Legacy script: MeSH annotation for 1-hop INDRA results."""
...
def main():
    ap = argparse.ArgumentParser(description="Annotate 1-hop INDRA results with MeSH terms.")
    ap.add_argument("--input", required=True, help="Input CSV with pmids column.")
    ...
    logger.info("Dropped %d invalid or unrecognized MeSH entries", dropped_terms_count)
